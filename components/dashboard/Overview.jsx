...
const Card = ({title, number, icon}) => {
 return ( <div className=" w-[175px] h-[95px] bg-[#323131] text-neutral-content p-[16px] flex items-center justify-center mt-[24px] mb-[16px] rounded-[8px]">
  <div className="items-center text-center">
    <h2 className="font-[500] font-space text-[12px] leading-4 mb-[12px]">{title} MODULES</h2>
    <div className="flex justify-between items-center">
      <button className="">{number}</button>
       <button className="">
         <img src={`/images/icons/dashboard/${icon}.png`} alt="total module" />
      </button>
    </div>
  </div>
</div>)
