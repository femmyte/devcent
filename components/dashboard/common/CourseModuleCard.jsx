		...
		<Link href={`/user/${link}`}>
			...
			>
				...
				<div className='w-full md:w-[300px] flex flex-col items-center justify-center'>
					<p className='font-space font-[400] text-[16px] leading-[20px] text-black'>
						{title}
					</p>
					<p className='font-space font-[400] text-[14px] leading-[18px] text-black'>
						{video} videos | {reading} Readings
					</p>
				</div>
				<div className='w-auto md:w-[188px] flex items-center justify-center py-[6px]  gap-x-[7px]'>
					<FaUser className='text-black' />
					<p className='font-space font-[400] text-[12px] leading-[15px] text-black'>
						{instructor}
					</p>
				</div>
				...
				<div className='flex items-center justify-center'>
					{isActive ? (
						<Link href={`/user/${link}`}>
							<p className='font-space font-[400] text-[30px] leading-[20px] text-black'>
								<FiArrowRight />
							</p>
						</Link>
					) : (
