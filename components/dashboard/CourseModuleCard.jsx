...
const CourseModuleCard = ({number, title, reading, video, instructor, percent, isActive}) => {
  return (
      <div className={`bw-[80%] md:w-[796px] md:h-[80px] flex justify-center items-center rounded-[8px] gap-x-[56px] px-[24px]`} style={{backgroundColor: isActive ? 'white' : '#e0e0e0'}}>
          ...
          <div className="w-[188px] flex flex-col items-start justify-center">
              ...
              <div className={` w-[${percent}%] bg-primaryPurple h-[10px] absolute top-0 left-0 rounded-[6px]`}></div>
              </div>
          </div>
