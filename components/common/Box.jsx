...
const Box = ({ title, description, img }) => {
  return (
    <Link href={""}>
      <div className="md:w-[380px] pt-[30px] md:pt-[50px] pb-[30px] md:pb-[50px] bg-white rounded-[35px] shadow shadow-[rgba(0, 0, 0, 0.14)] flex flex-col justify-center px-[20px] md:px-[30px] mb-[20px] md:mb-[0]">
