...
const Nav = ({ path }) => {
  ...
  return (
    <nav
      className={`z-[30] border-b border-[#494545] h-[64px] flex items-center relative bg-black ${
        menu ? "opacity-3" : ""
      }  bg-black font-source font-[600]`}
    >
      <div
        className={`${styles.maxWidth} md:py-3 text-white h-[80px] md:h-[60px] w-screen md:flex md:items-center text-[20px] justify-between`}
      >
