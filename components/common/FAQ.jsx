			...
			{show && (
				<div className='text-white text-left rounded-b-[8px]'>
					<div className='py-[16px] pl-[16px] pr-[30px]'>
						{' '}
						<p className='font-[400] text-[16px] md:text-[20px] leading-[25.52px] font-space text-white text-left'>
							{content}
						</p>
					</div>
				</div>
			...
			<div className='mt-[30px] md:mt-[80px] px-[20px] md:px-[70px] md:flex gap-x-[80px] items-center'>
				<div className=''>
					...
					<textarea
						name=''
						id=''
						className='w-full md:w-[554px] h-[80px] md:h-[200px] bg-[#1F1D1D] text-[#ADADAD] p-[20px] md:mt-[62px] md:mb-[40px] rounded-[20px] md:rounded-[40px]'
						placeholder='Type in your question'
					></textarea>
					<div className='flex flex-row items-center justify-center gap-x-[60px]'>
						<button className='text-white  bg-primaryPurple py-[10px] md:py-[16px] px-[20px] md:px-[32px] font-space font-bold text-[18px] md:text-[24px] hover:animate-pulse ease-out duration-300 rounded-[5px] my-[20px] md:my-0'>
							Send Message
						</button>
					</div>
				</div>
