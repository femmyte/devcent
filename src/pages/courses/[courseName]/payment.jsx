  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // const response = await axios.get(`api/orders/9518159586151938/order`);
      ...
      <div className="pt-[35px] px-[20px] md:px-[60px] text-white pb-[20px] md:pb-[60px]">
        ...
        <div className="">
          ...
          <p className="mt-[30px] font-source font-[400] text-white text-[14px] md:w-[848px] mb-[20px] md:mb-[60px] ">
            Your order has successfully been placed, kindly click the Make
            Payment button to proceed to payment. You will be redirected to a
            secure page where you’d be asked to input your card details or any
            other detail needed for any payment option you choose. Please, do
            not close your browser or this page at any point in the process.
          </p>
