      ...
      <div>
          <DashboardLayout>
              <div className='w-full flex flex-col md:flex-row justify-center md:justify-between pl-[15px] mt-[20px] md:mt-[31px]'>
                  <div className="">
                        <h1 className='font-[700] text-white text-[20px] md:text-[24px] leading-[30.24px] '>Course Outline</h1>
      <p className='font-plus font-[500] text-[16px] text-[#71717a] leading-[20.16px] mb-[20px] md:mb-[32px] mt-[8px]'>Explore your course module by module </p>
              {
                courseInformation.map(info => {
                  ...
                  return (
                    <div className="py-[12px]" key={number}>
                      <CourseModuleCard number={number} title={title} reading={reading} video={video} instructor={instructor} percent={percent}  isActive={isActive} link='moduleOne' />
                    </div>
                  )
                })
                }
              ...
              <div className='w-full mx-auto  min-h-[321px] rounded-[24px] py-[20px] px-[16px] bg-[#323131] text-white flex flex-col'>
                ...
                <div className='w-full min-h-[146px] rounded-[8px] py-[16px] pl-[10px] md:pl-[24px] pr-[6px] flex flex-col bg-white mt-[24px] text-[#828282]' style={{ boxShadow: '0px 2px 2px rgba(0, 0, 0, 0.25)' }}>
