...
const About = () => {
	return (
		<div>
			...
			<Nav />
			<div className="relative bg-[url('/images/video.png')] h-[120vh] md:h-[80vh] bg-cover bg-center overflow-hidden">
				<div
					className='absolute top-[1px] left-0 right-0 bottom-0 h-[120vh] md:h-[80vh] z-[1]'
					style={{
				...
				<div className='flex flex-col justify-center items-center relative z-[100] h-full px-[20px] md:px-[160px]'>
					<h1 className='font-space font-[700] text-[30px] md:text-[48px] leading-[30px] md:leading-[52px] text-white text-center mt-[35px] md:mt-0'>
			...
			<section className='px-[20px] md:px-[57px] py-[62px] bg-black w-full '>
				...
				<div className='md:flex gap-x-[80px] mt-[30px] md:mt-[80px]'>
