	...
	return (
        ...
        /> */}
			...
			<section className='bg-black pt-[30px] md:pt-[30px] pb-[50px] md:pb-[190px] px-[25px] relative'>
				<div className='lg:w-[85%] lg:mx-auto'>
					<h1 className='font-space font-[700] text-white text-[30px] md:text-[40px] leading-[35px] md:leading-[51px] text-center mx-[20px] md:mx-[70px] mt-[50px] '>
						Develop In-Demand Tech Skills. Learn At Your Own Pace.
						Build a happier tech life. Experience the magic at
						Devcent
					</h1>
				</div>
					...
					<div className='md:grid md:grid-cols-3 md:gap-x-[80px] px-[10px] md:px-[100px] mt-[20px] md:mt-[50px]'>
						<div className='flex gap-x-[15px] md:gap-x-[24px] items-center'>
							...
							<div>
								...
								<p className='text-[18px] font-space font-[400] leading-[23px] text-[#9b9b9b]'>
									Get skilled through lectures and practical
									sessions.
								</p>
							</div>
						</div>
						<div className='my-[20px] md:my-0 flex gap-x-[24px] items-center'>
							...
							<div>
								...
								<p className='text-[18px] font-space font-[400] leading-[23px] text-[#9b9b9b]'>
									Work on multiple projects to gain hands-on
									exposure and real world work experience.
								</p>
							</div>
						</div>
						<div className='flex gap-x-[24px] items-center'>
							...
							<div>
								...
								<p className='text-[18px] font-space font-[400] leading-[23px] text-[#9b9b9b]'>
									Our training pushes your limits, sharpens
									your skills, and propels you towards mastery
									in your field.
								</p>
							</div>
						</div>
                ...
                LIVE PROJECTS
					...
					>
						<p className='font-space font-[400] text-[30px] xl:text-[37px] leading-[35px] xl:leading-[44.72px] text-black'>
							Take the next step towards <br /> your personal and{' '}
							<br /> professional goals with <br />
							Devcent.
						</p>
						...
						<p className='mt-[34px] xl:mr-[60px] text-black'>
							At Devcent, we are more than a learning platform. We
							are your partner in growth and success. With our
							wide range of advanced courses, expert instructors,
							and hands-on learning experiences, you'll be
							equipped with the required skills and knowledge to
							master your craft.
						</p>
			...
			<section className='pt-[40px] pb-[40px] md:pb-[200px] px-[20px] md:px-[80px] bg-black text-white'>
						...
						<div className='flex gap-x-[15px] md:gap-x-[30px] items-start'>
							...
							<div className='md:max-w-[400px]'>
								...
								<p className='font-dmsans font-regular text-[18.5px] leading-[24px] pb-[20px] md:pb-0'>
									...
									and industry experts. Expand your network,
									fostering collaborations that can lead to
									exciting opportunities and lifelong
									connections.
								</p>
							</div>
						</div>
						<div className='flex gap-x-[15px] md:gap-x-[30px] items-start'>
							...
							<div className='md:max-w-[400px]'>
								...
								<p className='font-dmsans font-regular text-[18.5px] leading-[24px]'>
									...
									throughout your learning journey. You are
									ensured that you stay motivated, overcome
						...
						<div className='flex gap-x-[15px] md:gap-x-[30px] items-start'>
							...
							<div className='md:max-w-[400px]'>
								...
								<p className='font-dmsans font-regular text-[18.5px] leading-[24px] pb-[20px] md:pb-0'>
									...
									instructors and industry professionals. Gain
									a deeper understanding of the field from
									their shared insights, best practices, and
									real-world examples.
								</p>{' '}
							</div>
						</div>
						<div className='flex gap-x-[15px] md:gap-x-[30px] items-start'>
							...
							<div className='md:max-w-[400px]'>
								...
								<p className='font-dmsans font-regular text-[18.5px] leading-[24px]'>
									...
									skills in the tech industry. Equip yourself
									with the skills that companies are actively
									seeking. Engage in practical, real-world
				...
				<div className='mt-[13px] md:ml-[28px] md:flex gap-x-[80px] gap-y-[40px] justify-center flex-wrap'>
					<div className='mt-[40px] max-w-[299px]'>
						...
						<p className='mt-[13px] font-dmsans font-[700] text-[15px] leading-[20px] text-[#9b9b9b] '>
							With our beginner-friendly approach, you'll build a
							solid foundation and gain the confidence needed to
							navigate the exciting world of tech.
						</p>
					</div>
					<div className='mt-[40px] max-w-[299px]'>
						<div className='flex items-center'>
					...
					<div className='mt-[40px] max-w-[299px]'>
						...
						<p className='mt-[13px] font-dmsans font-[700] text-[15px] leading-[20px] text-[#9b9b9b] '>
							At Devcent, we offer the flexibility to take your
							lectures at your convenient time.
						</p>
					</div>
					{/* </div>
				<div className='mt-[13px] md:ml-[28px] md:grid grid-cols-3 gap-4 place-items-center'> */}
					<div className='mt-[40px] max-w-[299px]'>
						...
						<p className='mt-[13px] font-dmsans font-[700] text-[15px] leading-[20px] text-[#9b9b9b] '>
							Earn a certificate upon successful completion of our
							courses.
						</p>
					</div>
					<div className='mt-[40px] max-w-[299px]'>
