  ...
  return (
    <div>
      ...
      {/* <div
        ...
        /> */}
      <Nav />
      <div className="bg-black flex flex-col-reverse lg:flex-row gap-x-[50px] items-center text-white z-10 px-[25px] md:pl-[90px] relative">
        ...
        >
          <div className="lg:w-[85%] lg:mx-auto">
            <h1 className="font-space font-[700] text-white text-[30px] md:text-[40px] leading-[35px] md:leading-[51px] text-center mx-[20px] md:mx-[70px] mt-[50px] ">
              Develop In-Demand Tech Skills. Learn At Your Own Pace. Build a
              happier tech life. Experience the magic at Devcent
            </h1>
          </div>
        </Animation>
        <p className="md:w-[70%] mt-[90px] text-[25px] text-center font-dmsans leading-[33px] mx-auto text-[#ffba0e] mb-[80px] md:mb-[100px]">
          Embark on an exciting learning journey with our online UX/UI & coding
          bootcamps, designed to provide hands-on practice in a global community
