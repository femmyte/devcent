...
const index = () => {
	return (
        ...
        /> */}
			...
			<div className='bg-black flex flex-col-reverse md:flex-row justify-between text-white z-10 md:pl-[96px] md:pr-[95px] relative h-[100vh]'>
				<div className='w-full md:w-[580px] mt-[30px] md:mt-[160px] text-center md:text-left'>
					...
					<p className='text-[20px] md:text-[24px] leading-6 md:leading-10 my-[20px]  '>
						Our Trainings are designed to help you learn <br /> from
						the best industry experts around.
					</p>
			...
			<section className='bg-black pt-[30px] md:pt-[30px] pb-[50px] md:pb-[190px] px-[10px] relative'>
				<h1 className='font-space font-[700] text-white text-[30px] md:text-[40px] leading-[35px] md:leading-[51px] text-center mx-[20px] md:mx-[70px] mt-[50px] '>
					Develop tech skills. save times. Build happier tech life.
					And transform your goals into gains. All with Devcent
				</h1>
				<p className='md:w-[886px] mt-[90px] text-[25px] text-center font-dmsans leading-[33px] mx-auto text-[#ffba0e] mb-[20px] md:mb-[100px]'>
					Our online UX/UI & coding bootcamps are created to support
					you in learning via practice in a mini class of about 30
					people globally.
				</p>
					...
					<div className='md:grid md:grid-cols-3 md:gap-x-[80px] px-[10px] md:px-[100px] mt-[20px] md:mt-[50px]'>
						...
						<div className='my-[20px] md:my-0 flex gap-x-[24px] items-center'>
							...
							<div>
								...
								<p className='text-[18px] font-space font-[400] leading-[23px] text-[#9b9b9b]'>
									Get to work on multiple projects to gain
									know-how.
								</p>
							</div>
						</div>
              ...
              <p className="font-source font-regular text-[22px] leading-[30px]">
				...
				>
					...
					<p className='mt-[34px] md:mr-[60px]'>
						Lorem ipsum dolor sit amet consectetur. Ac venenatis
						turpis pellentesque sit quam egestas. Est viverra vitae
						at lobortis mi eget pulvinar. Sit orci sollicitudin enim
						habitant rhoncus donec. Nisi amet tempor consequat
						ultrices suspendisse justo. Tortor et adipiscing egestas
						gravida eu nibh. Ultrices nam enim tristique sagittis
						auctor at penatibus neque urna. Non risus magna lacus.
					</p>
			...
			<section className='pt-[40px] pb-[40px] md:pb-[200px] px-[20px] md:px-[80px] bg-black text-white'>
				...
				<p className='md:w-[1015px] mx-auto text-center mt-[40px] mb-[20px] md:mb-[80px] font-dmsans font-[400] text-[20px] leading-[26px] text-[#9b9b9b]'>
					Coding, Designing, Prototyping, digital Marketing,
					Programming, Networking skills have never been more
					in-demand. Learn everything you need to take your career to
					the next level.
				</p>
						...
						<div className='flex gap-x-[15px] md:gap-x-[30px] items-start'>
							...
							<div className='md:w-[400px]'>
								...
								<p className='font-dmsans font-regular text-[18.5px] leading-[24px] pb-[20px] md:pb-0'>
									We train and teach you Computer and ICT
									skills from scratch to professional level.
									Even if you are a novice in computer, then
              ...
              Learn More
				...
				<div className='mt-[13px] md:ml-[28px] md:grid grid-cols-3 gap-4 place-items-center'> */}
					<div className='mt-[40px] max-w-[299px]'>
						...
						<p className='mt-[13px] font-dmsans font-[700] text-[15px] leading-[20px] text-[#9b9b9b] '>
							We offer certificate when you are done with youer
							lectures
						</p>
					</div>
					<div className='mt-[40px] max-w-[299px]'>
